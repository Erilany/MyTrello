...
.column:nth-child(1) { animation: fadeSlide 0.4s ease 0.05s both; }
.column:nth-child(2) { animation: fadeSlide 0.4s ease 0.10s both; }
.column:nth-child(3) { animation: fadeSlide 0.4s ease 0.15s both; }
.column:nth-child(4) { animation: fadeSlide 0.4s ease 0.20s both; }
```
...
```css
/* Colonne Études */   background: linear-gradient(90deg, #6366f1, #3b82f6);
/* Colonne En cours */ background: linear-gradient(90deg, #f59e0b, #fbbf24);
/* Colonne Réalisé */  background: linear-gradient(90deg, #22c55e, #4ade80);
/* Colonne Archivé */  background: #475569;  /* pas de dégradé — état éteint */
```
